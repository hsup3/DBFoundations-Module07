...
-- 2023-02-28,PYHSU,Created File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment07DB_PYHSU')
	 Begin 
	  Alter Database [Assignment07DB_PYHSU] set Single_user With Rollback Immediate;
	  Drop Database Assignment07DB_PYHSU;
	 End
	Create Database Assignment07DB_PYHSU;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment07DB_PYHSU;
...
AS
  ...
  ,[CountVsPreviousCountKPI] = ISNULL(Case
    WHEN InventoryCount > [PreviousMonthCount] Than 1
	WHEN InventoryCount = [PreviousMonthCount] Than 0
	WHEN InventoryCount < [PreviousMonthCount] Than -1
	End,0)
